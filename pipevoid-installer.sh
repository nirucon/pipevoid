...
sudo xbps-install -Sy xorg-minimal xinit suckless-tools pipewire alsa-utils alsa-plugins alsa-firmware pipewire-pulse wireplumber pavucontrol volumeicon
